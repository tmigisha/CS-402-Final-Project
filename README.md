...
## Overview
This app is the classic board game, mastermind digitalized. Where the computer is the mastermind who creates a secret set of patterns made up of colors. Its up to the user to guess the correct order of the pattern.  The user are given hints via + and - , that tells if its in the correct or wrong color/postion.  The functionality of the app are as follows:
* Homepage - The homepage with various options for gameplay
    ...
    - No duplicates - option with no duplicate color/symbol
